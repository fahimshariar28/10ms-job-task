...
export default function CoursePointer({ coursePointer }: CoursePointerProps) {
  return (
    <section className="my-5 mx-5 md:mx-24 border-t-8 border-gray-200 md:border-0">
      <h2 className="text-2xl mt-4 font-semibold text-gray-900 mb-2 md:mb-8">
        {coursePointer.name}
      </h2>
      <div className="grid md:grid-cols-2 gap-6 md:border border-gray-300 rounded-lg md:py-3 md:px-8">
